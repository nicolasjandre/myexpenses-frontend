...
export function Button({
  ...
  return isDisabled ? (
    <button
      ...
      hover:bg-pos-100 transition-all duration-500 opacity-30 cursor-not-allowed ${tailwindClass}`}
      {...rest}
    >
      <MiniLoader />
      {title}
    ...
    <button
      ...
      hover:bg-pos-100 transition-all duration-500 hover:bg-blue-800 hover:shadow-lg ${tailwindClass}`}
      {...rest}
    >
      {title}
    </button>
