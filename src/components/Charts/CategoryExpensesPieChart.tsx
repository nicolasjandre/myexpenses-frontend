...
export function CategoryExpensesPieChart() {
    ...
    const { isLast7OrLast30DaysExpensesPieChart, setIsLast7OrLast30DaysExpensesPieChart } =
    ...
    const expenseOptions: ApexOptions = {
        series:
            data?.expensesByCostCenter.map(
                (income: ExpensesIncomesByCostCenter) => income?.total
            ) || [],
        dataLabels: {
            style: {
                fontSize: "14px",
    ...
    2smw:flex 2smw:flex-col 2smw:items-center 2smw:justify-center"
      ...
      2smw:flex-col 2smw:items-center 2smw:justify-center 2smw:gap-4 2smw:pb-6"
                ...
                <div className="min-h-[22vw] mdw:min-h-[30vw]">
                    ...
                    ) : data?.expensesByCostCenter?.length !== 0 && data !== undefined ? (
                        <ExpensesPieChart
                            width="100%"
                            type="pie"
